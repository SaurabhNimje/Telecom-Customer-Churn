# -*- coding: utf-8 -*-
"""
Created on Thu Feb  9 05:22:22 2023
...
probability = probability.astype(float).round(3)

if st.button('Predict'):
    if prediction == 1:
        st.warning('Result: 1 = Yes, this customer is likely to be churned.')
    else:
        st.success('Result: 0 = No, this customer is likely to continue.')
